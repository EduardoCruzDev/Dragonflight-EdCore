...
$config['page_title'] = "WoW Sky"; // The title of your website as displayed in the browser tab.
$config['language'] = "spanish"; // The default language for your website.
...
$config['template'] = 'advance'; // Available template: advance(DragonFlight).
...
$config['vote_sites'] = array(
    ...
    // array(
    //     'image' => 'http://www.top100arena.com/hit.asp?id=yourcodehere&c=WoW&t=2',
    //     'site_url' => 'http://www.top100arena.com/in.asp?id=yourcodehere'
    // ),
    // array(
    //     'image' => 'https://topg.org/topg.gif',
    //     'site_url' => 'https://topg.org/wow-private-servers/in-yourcodehere'
    // ),
    // array(
    //     'image' => 'http://www.xtremeTop100.com/votenew.jpg',
    //     'site_url' => 'http://www.xtremetop100.com/in.php?site=yourcodehere'
    // )
);
...
$config['db_auth_pass'] = 'YourPasswordHere'; // Database password.
$config['db_auth_dbname'] = 'auth10'; // Database name for your auth/realmd database.

// Realmlist Configuration - Configure the connection details for each realm's character database.
$config['realmlists'] = array(
    "1" => array(
        'realmid' => 1, // Realm ID
        'realmname' => "Sky", // Realm Name
        'db_host' => "127.0.0.1", // MySQL Host IP
        'db_port' => "3306", // MySQL Host Port
        'db_user' => "root", // MySQL username
        'db_pass' => 'YourPasswordHere', // MySQL password
        'db_name' => "characters10" // Characters database name
    )
);
