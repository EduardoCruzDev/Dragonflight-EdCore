...
<body>
<section id="hero"
         style="background-image: url('<?php echo $antiXss->xss_clean(get_config("baseurl")); ?>/template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/assets/img/wow-bg/<?php echo get_config('expansion') . '-' . rand(1, 7); ?>.jpg');background-size: cover;">
    <div class="hero-container">
        <a href="" class="hero-logo" data-aos="zoom-in"><img style="width: 30rem; max-width: 100%;"
                                                             src="<?php echo $antiXss->xss_clean(get_config("baseurl")); ?>/template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/assets/img/logo-1.webp"
                                                             alt=""></a>
        <h1 data-aos="zoom-in"
